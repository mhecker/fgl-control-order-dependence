...
define(COMMON_DEPENDENCIES, `process >= 1.2.3, base >=4.8, deepseq, base-unicode-symbols >=0.2, containers >=0.5, ordered-containers >= 0.2.1, fgl >=5.5, fgl-arbitrary == 0.2.0.3, fgl-visualize >= 0.1.0.1, QuickCheck >=2.8, logict >=0.6, random >=1.1, MonadRandom == 0.5.1, containers-unicode-symbols == 0.3.1.1, lattices >= 1.5.0, dequeue == 0.1.12, bitwise == 0.1.1.1')dnl
