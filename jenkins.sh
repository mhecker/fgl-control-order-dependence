...
time timeout 60m make dist/build/cdom.valid.xml.bin/cdom.valid.xml                     RTS="+RTS -M22288m -RTS" PATTERN="-p '**/Properties/**'"
...
time timeout 60m make dist/build/timing.valid.xml.bin/timingDep.valid.xml              RTS="+RTS -M22288m -RTS" PATTERN="-p '**/Properties/**'"
time             make dist/build/timing.valid.xml.bin/simon.valid.xml                  RTS="+RTS -M22288m -RTS" PATTERN="-p '**/Properties/**'"
...
time timeout 60m make dist/build/ntscd.valid.xml.bin/ntscd.valid.xml                   RTS="+RTS -M22288m -RTS" PATTERN="-p '**/Properties/**'"
time timeout 60m make dist/build/newcd.valid.xml.bin/newcd.valid.xml                   RTS="+RTS -M22288m -RTS" PATTERN="-p '**/Properties/**'"
...
time timeout 60m make dist/build/color.valid.xml.bin/color.valid.xml                   RTS="+RTS -M22288m -RTS" PATTERN="-p '**/Properties/**'"
time timeout 60m make dist/build/reducible.valid.xml.bin/reducible.valid.xml           RTS="+RTS -M22288m -RTS" PATTERN="-p '**/Properties/**'"
time timeout 60m make dist/build/indeps.valid.xml.bin/indeps.valid.xml                 RTS="+RTS -M22288m -RTS" PATTERN="-p '**/Properties/**'"
time timeout 60m make dist/build/delay.valid.xml.bin/delay.valid.xml                   RTS="+RTS -M22288m -RTS" PATTERN="-p '**/Properties/**'"
time timeout 60m make dist/build/insensitiveDom.valid.xml.bin/insensitiveDom.valid.xml RTS="+RTS -M22288m -RTS" PATTERN="-p '**/Properties/**'"
time timeout 60m make dist/build/sensitiveDom.valid.xml.bin/sensitiveDom.valid.xml     RTS="+RTS -M22288m -RTS" PATTERN="-p '**/Properties/**'"
