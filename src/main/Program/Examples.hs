...
import Program
import Program.Generator (Generated(..), GeneratedProgram(..), IntraGeneratedProgram(..), SimpleWithArraysProgram(..), toProgram, toProgramIntra, toCodeSimpleWithArrays)
import Program.For
...
-- 6th 
notReallyUnsound36:: Program Gr
notReallyUnsound36 = toProgramIntra $ IntraGeneratedProgram
    (Map.fromList [(1,"main"),(2,"thread2"),(3,"thread3")])
    (Map.fromList [("main",Generated (Seq (Seq (Seq (PrintToChannel (Val (-1)) "stdOut") (SpawnThread 3)) (ForC 2 (PrintToChannel (Val 1) "stdOut"))) (Seq (Seq (PrintToChannel (Val 9) "stdOut") (Ass (Global "a") (Val 0))) (If (Leq (Val 0) (Plus (Var (Global "a")) (Var (Global "a")))) (SpawnThread 2) (ReadFromChannel (Global "z") "lowIn1")))) undefined undefined undefined),("thread2",Generated (Seq (Seq (Seq (PrintToChannel (Plus (Var (Global "a")) (Var (Global "a"))) "stdOut") (PrintToChannel (Var (Global "a")) "stdOut")) (ForC 2 (ReadFromChannel (Global "c") "stdIn"))) (Seq (ForC 2 (Ass (Global "a") (Val 0))) (ForC 1 (Ass (Global "b") (Times (Var (Global "a")) (Var (Global "a"))))))) undefined undefined undefined),("thread3",Generated (Seq (Seq (Ass (Global "b") (Val 0)) (ReadFromChannel (Global "x") "stdIn")) (Seq (PrintToChannel (Val 0) "stdOut") (ReadFromChannel (Global "y") "lowIn1"))) undefined undefined undefined)])


-- 7th 
notReallyUnsound37:: Program Gr
notReallyUnsound37 = toProgramIntra $ IntraGeneratedProgram
    (Map.fromList [(1,"main"),(2,"thread2")])
    (Map.fromList [("main",Generated (Seq (Seq (Seq (ReadFromChannel (Global "a") "lowIn1") (SpawnThread 2)) (ForC 1 (Ass (Global "b") (Neg (Var (Global "a")))))) (Seq (Seq (Ass (Global "z") (Val 1)) (ReadFromChannel (Global "c") "lowIn1")) (Seq Skip Skip))) undefined undefined undefined),("thread2",Generated (ForC 1 (Seq (If (Leq (Val 0) (Val 1)) (If (Leq (Val 0) (Val 1)) (PrintToChannel (Neg (Var (Global "a"))) "stdOut") (PrintToChannel (Var (Global "a")) "stdOut")) (Seq (PrintToChannel (Neg (Var (Global "a"))) "stdOut") (ReadFromChannel (Global "z") "lowIn1"))) (ForC 2 (Seq (ReadFromChannel (Global "b") "lowIn1") (ReadFromChannel (Global "c") "stdIn"))))) undefined undefined undefined)])

-- 8th 
notReallyUnsound38:: Program Gr
notReallyUnsound38 = toProgramIntra $ IntraGeneratedProgram
    (Map.fromList [(1,"main"),(2,"thread2"),(3,"thread3")])
    (Map.fromList [("main",Generated (Seq (Seq (ForC 1 (ReadFromChannel (Global "a") "lowIn1")) (Seq (SpawnThread 2) (ReadFromChannel (Global "c") "stdIn"))) (ForC 2 (If (Leq (Val 0) (Times (Var (Global "c")) (Var (Global "c")))) (Ass (Global "y") (Var (Global "a"))) Skip))) undefined undefined undefined),("thread2",Generated (Seq (Seq (If (Leq (Val 0) (Neg (Var (Global "a")))) (ReadFromChannel (Global "c") "lowIn1") (ReadFromChannel (Global "z") "lowIn1")) (Seq (SpawnThread 3) (PrintToChannel (Times (Var (Global "a")) (Var (Global "a"))) "stdOut"))) (ForC 1 (If (Leq (Val 0) (Val (-1))) (Ass (Global "z") (Neg (Var (Global "a")))) (ReadFromChannel (Global "x") "lowIn1")))) undefined undefined undefined),("thread3",Generated (If (Leq (Val 0) (Var (Global "a"))) (ForC 1 (PrintToChannel (Plus (Var (Global "a")) (Var (Global "a"))) "stdOut")) (If (Leq (Val 0) (Plus (Var (Global "a")) (Var (Global "a")))) (ReadFromChannel (Global "x") "stdIn") (PrintToChannel (Neg (Var (Global "a"))) "stdOut"))) undefined undefined undefined)])

-- 9th 
notReallyUnsound39:: Program Gr
notReallyUnsound39 = toProgramIntra $ IntraGeneratedProgram
    (Map.fromList [(1,"main"),(2,"thread2"),(3,"thread3")])
    (Map.fromList [("main",Generated (ForC 1 (Seq (If CTrue (SpawnThread 3) Skip) (If CTrue (PrintToChannel (Val (-1)) "stdOut") (PrintToChannel (Val (-1)) "stdOut")))) undefined undefined undefined),("thread2",Generated (Seq (ForC 2 (Ass (Global "a") (Val 9))) (Seq (Ass (Global "y") (Val 9)) (PrintToChannel (Neg (Var (Global "a"))) "stdOut"))) undefined undefined undefined),("thread3",Generated (If CTrue (Seq (Seq (PrintToChannel (Val (-1)) "stdOut") (PrintToChannel (Val (-1)) "stdOut")) (If CFalse (PrintToChannel (Val 4) "stdOut") (ReadFromChannel (Global "y") "stdIn"))) (Seq (If CFalse Skip (PrintToChannel (Val (-1)) "stdOut")) (Seq (ReadFromChannel (Global "x") "stdIn") (SpawnThread 2)))) undefined undefined undefined)])

-- 10th 
notReallyUnsound40 :: Program Gr
notReallyUnsound40 = toProgramIntra $ IntraGeneratedProgram
    (Map.fromList [(1,"main"),(2,"thread2"),(3,"thread3")])
    (Map.fromList [("main",Generated (ForC 2 (If CFalse (ForC 1 (Seq (SpawnThread 2) (Ass (Global "b") (Val 4)))) (Seq (Seq (SpawnThread 3) (PrintToChannel (Val 4) "stdOut")) (Seq (ReadFromChannel (Global "x") "lowIn1") (PrintToChannel (Plus (Var (Global "x")) (Var (Global "x"))) "stdOut"))))) undefined undefined undefined),("thread2",Generated (ForC 1 (Seq (ForC 2 (If CFalse (ReadFromChannel (Global "b") "stdIn") (Ass (Global "z") (Val 9)))) (Seq (Seq (ReadFromChannel (Global "b") "lowIn1") (Ass (Global "y") (Val 9))) (Seq (Ass (Global "b") (Val 0)) (ReadFromChannel (Global "x") "lowIn1"))))) undefined undefined undefined),("thread3",Generated (Seq (ForC 1 (PrintToChannel (Val 9) "stdOut")) (Seq Skip (Ass (Global "z") (Val 1)))) undefined undefined undefined)])

-- 11th 
notReallyUnsound41 :: Program Gr
notReallyUnsound41 = toProgramIntra $ IntraGeneratedProgram
    (Map.fromList [(1,"main"),(2,"thread2"),(3,"thread3")])
    (Map.fromList [("main",Generated (If CFalse (ForC 1 (ForC 1 (ForC 1 (Ass (Global "a") (Val 1))))) (Seq (Seq (SpawnThread 2) (Ass (Global "a") (Val 1))) (If (Leq (Val 0) (Val 9)) (SpawnThread 3) (ReadFromChannel (Global "z") "lowIn1")))) undefined undefined undefined),("thread2",Generated (If CFalse (If CFalse (Seq (ReadFromChannel (Global "c") "lowIn1") (ReadFromChannel (Global "b") "stdIn")) (Seq (PrintToChannel (Val (-1)) "stdOut") Skip)) (ForC 2 (Seq (Ass (Global "a") (Val 0)) (PrintToChannel (Plus (Var (Global "a")) (Var (Global "a"))) "stdOut")))) undefined undefined undefined),("thread3",Generated (Seq (Seq (PrintToChannel (Var (Global "a")) "stdOut") (Ass (Global "z") (Plus (Var (Global "a")) (Var (Global "a"))))) (If (Leq (Val 0) (Neg (Var (Global "a")))) (Ass (Global "b") (Times (Var (Global "z")) (Var (Global "z")))) (Ass (Global "c") (Plus (Var (Global "z")) (Var (Global "z")))))) undefined undefined undefined)])

-- 12th 
notReallyUnsound42 :: Program Gr
notReallyUnsound42 = toProgramIntra $ IntraGeneratedProgram
    (Map.fromList [(1,"main"),(2,"thread2")])
    (Map.fromList [("main",Generated (Seq (Seq (Seq (PrintToChannel (Val 4) "stdOut") (SpawnThread 2)) (ForC 1 (PrintToChannel (Val 4) "stdOut"))) (If CTrue (Seq (Ass (Global "z") (Val 0)) (PrintToChannel (Neg (Var (Global "z"))) "stdOut")) (Seq (Ass (Global "a") (Val 1)) (PrintToChannel (Val (-1)) "stdOut")))) undefined undefined undefined),("thread2",Generated (Seq (Seq (Seq (PrintToChannel (Val 0) "stdOut") (PrintToChannel (Val 1) "stdOut")) (Seq (ReadFromChannel (Global "a") "lowIn1") Skip)) (Seq (Seq (ReadFromChannel (Global "x") "stdIn") (Ass (Global "b") (Var (Global "a")))) (Seq (ReadFromChannel (Global "y") "stdIn") (ReadFromChannel (Global "x") "lowIn1")))) undefined undefined undefined)])

-- 13th 
notReallyUnsound43 :: Program Gr
notReallyUnsound43 = toProgramIntra $ IntraGeneratedProgram
    (Map.fromList [(1,"main"),(2,"thread2"),(3,"thread3")])
    (Map.fromList [("main",Generated (Seq (Seq (If CFalse (ReadFromChannel (Global "b") "stdIn") (SpawnThread 3)) (Seq (SpawnThread 2) (ReadFromChannel (Global "c") "lowIn1"))) (ForC 1 (Seq (Ass (Global "c") (Val 4)) (Ass (Global "y") (Neg (Var (Global "c"))))))) undefined undefined undefined),("thread2",Generated (Seq (If CFalse (Seq (Ass (Global "x") (Val (-1))) (Ass (Global "c") (Times (Var (Global "x")) (Var (Global "x"))))) (Seq Skip (PrintToChannel (Val 9) "stdOut"))) (Seq (Seq (Ass (Global "c") (Val 0)) (ReadFromChannel (Global "a") "lowIn1")) (ForC 1 (PrintToChannel (Plus (Var (Global "c")) (Var (Global "a"))) "stdOut")))) undefined undefined undefined),("thread3",Generated (Seq (Seq (ReadFromChannel (Global "a") "lowIn1") (ReadFromChannel (Global "a") "lowIn1")) (Seq (PrintToChannel (Times (Var (Global "a")) (Var (Global "a"))) "stdOut") (Ass (Global "a") (Var (Global "a"))))) undefined undefined undefined)])



notReallyUnsound44 :: Program Gr
notReallyUnsound44 = toProgramIntra $ IntraGeneratedProgram
    (Map.fromList [(1,"main"),(2,"thread2")])
    (Map.fromList [("main",Generated (Seq (Seq (ForC 2 (SpawnThread 2)) (If CFalse (ReadFromChannel (Global "c") "lowIn1") (ReadFromChannel (Global "x") "lowIn1"))) (ForC 1 (Seq (PrintToChannel (Val 5) "stdOut") Skip))) undefined undefined undefined),("thread2",Generated (Seq (ForC 1 (If CFalse (PrintToChannel (Val 5) "stdOut") (PrintToChannel (Val 5) "stdOut"))) (Seq (Seq (ReadFromChannel (Global "a") "lowIn1") (PrintToChannel (Val 4) "stdOut")) (Seq (ReadFromChannel (Global "z") "stdIn") Skip))) undefined undefined undefined)])


notReallyUnsound45 :: Program Gr
notReallyUnsound45 = toProgramIntra $ IntraGeneratedProgram
    (Map.fromList [(1,"main"),(3,"thread3")])
    (Map.fromList [("main",Generated (Seq (Seq (Seq (PrintToChannel (Val 5) "stdOut") (PrintToChannel (Val 13) "stdOut")) (Seq (Ass (Global "y") (Val 8)) (SpawnThread 3))) (Seq (ForC 2 (ReadFromChannel (Global "a") "stdIn")) (ForV (Global "y") (PrintToChannel (Neg (Var (Global "y"))) "stdOut")))) undefined undefined undefined),("thread3",Generated (Seq (Seq (Seq (PrintToChannel (Val 8) "stdOut") (PrintToChannel (Val 3) "stdOut")) (If (Leq (Val 4) (Val 3)) (Ass (Global "x") (Val 8)) (PrintToChannel (Times (Var (Global "y")) (Var (Global "y"))) "stdOut"))) (Seq (Seq (PrintToChannel (Plus (Var (Global "y")) (Var (Global "y"))) "stdOut") Skip) (ForC 2 (ReadFromChannel (Global "x") "lowIn1")))) undefined undefined undefined)])

notReallyUnsound46 :: Program Gr
notReallyUnsound46 = toProgramIntra $ IntraGeneratedProgram
    (Map.fromList [(1,"main"),(2,"thread2")])
...
exampleMhp = toProgram $ GeneratedProgram
    (Map.fromList [(1,"main"),(2,"thread2"),(3,"thread3")])
    (Map.fromList [("bar",Generated (Seq (Seq (If (Leq (Val 0) (Var (Global "c"))) (If (Leq (Val 0) (Plus (Var (Global "c")) (Var (Global "c")))) (ReadFromChannel (Global "z") "stdIn") Skip) (If (Leq (Val 0) (Plus (Var (Global "c")) (Var (Global "c")))) (ReadFromChannel (Global "x") "lowIn1") (ReadFromChannel (Global "y") "lowIn1"))) (Seq (Seq (Ass (Global "z") (Neg (Var (Global "c")))) (Ass (Global "c") (Var (Global "z")))) (If (Leq (Val 0) (Val 1)) (SpawnThread 3) (ReadFromChannel (Global "x") "stdIn")))) (Seq (Seq (ForV (Global "z") (PrintToChannel (Plus (Var (Global "c")) (Var (Global "z"))) "stdOut")) (ForC 2 (Ass (Global "a") (Var (Global "c"))))) (Seq (ForC 2 (CallProcedure "bar")) (If (Leq (Val 0) (Val 4)) (PrintToChannel (Neg (Var (Global "z"))) "stdOut") (CallProcedure "baz"))))) undefined undefined undefined),("baz",Generated (If (Leq (Val 0) (Val 9)) (Seq (CallProcedure "procG") (Ass (Global "z") (Val 9))) (Seq Skip (Ass (Global "y") (Neg (Var (Global "a")))))) undefined undefined undefined),("foo",Generated (Seq (ForV (Global "z") (Ass (Global "y") (Plus (Var (Global "c")) (Var (Global "z"))))) (If (Leq (Val 0) (Neg (Var (Global "c")))) (PrintToChannel (Neg (Var (Global "z"))) "stdOut") (Ass (Global "z") (Var (Global "c"))))) undefined undefined undefined),("main",Generated (Seq (ForC 2 (ForC 2 (ForC 1 (Seq (Seq (Ass (Global "c") (Val 9)) (PrintToChannel (Times (Var (Global "c")) (Var (Global "c"))) "stdOut")) (Seq (CallProcedure "bar") (ReadFromChannel (Global "y") "lowIn1")))))) (If (Leq (Val 0) (Neg (Var (Global "y")))) (Seq (Seq (PrintToChannel (Neg (Var (Global "y"))) "stdOut") (CallProcedure "procG")) (Seq (ReadFromChannel (Global "x") "lowIn1") (PrintToChannel (Neg (Var (Global "y"))) "stdOut"))) (If (Leq (Val 0) (Var (Global "c"))) (Seq (PrintToChannel (Neg (Var (Global "y"))) "stdOut") (Ass (Global "z") (Val (-1)))) (ForC 2 (CallProcedure "procH"))))) undefined undefined undefined),("procF",Generated (Seq (Seq (ReadFromChannel (Global "b") "lowIn1") (Ass (Global "y") (Val 0))) (Seq (CallProcedure "procH") (Ass (Global "y") (Var (Global "c"))))) undefined undefined undefined),("procG",Generated (If (Leq (Val 0) (Var (Global "c"))) (If (Leq (Val 0) (Val 4)) (PrintToChannel (Plus (Var (Global "c")) (Var (Global "c"))) "stdOut") (Ass (Global "z") (Plus (Var (Global "c")) (Var (Global "c"))))) (Seq (CallProcedure "procH") (ReadFromChannel (Global "x") "stdIn"))) undefined undefined undefined),("procH",Generated (Seq (Seq Skip (Ass (Global "c") (Plus (Var (Global "c")) (Var (Global "c"))))) (Seq (CallProcedure "procH") (CallProcedure "procH"))) undefined undefined undefined),("thread2",Generated (ForV (Global "z") (Seq (Seq (Seq (CallProcedure "foo") (PrintToChannel (Var (Global "c")) "stdOut")) (Seq (PrintToChannel (Val 4) "stdOut") (ReadFromChannel (Global "a") "lowIn1"))) (ForC 2 (Seq (PrintToChannel (Times (Var (Global "z")) (Var (Global "c"))) "stdOut") (PrintToChannel (Plus (Var (Global "a")) (Var (Global "c"))) "stdOut"))))) undefined undefined undefined),("thread3",Generated (If (Leq (Val 0) (Neg (Var (Global "z")))) (ForV (Global "c") (If (Leq (Val 0) (Neg (Var (Global "z")))) (If (Leq (Val 0) (Var (Global "z"))) (ForC 1 (SpawnThread 2)) (Seq (PrintToChannel (Val 1) "stdOut") (CallProcedure "procH"))) (Seq (If (Leq (Val 0) (Times (Var (Global "z")) (Var (Global "z")))) (CallProcedure "procG") (CallProcedure "procF")) (If (Leq (Val 0) (Var (Global "z"))) (PrintToChannel (Neg (Var (Global "z"))) "stdOut") (Ass (Global "x") (Neg (Var (Global "z")))))))) (ForC 1 (Seq (Seq (ForV (Global "z") (PrintToChannel (Var (Global "z")) "stdOut")) (ForC 1 (PrintToChannel (Val 4) "stdOut"))) (Seq (ForV (Global "c") (Ass (Global "x") (Val 4))) (Seq (Ass (Global "c") (Times (Var (Global "c")) (Var (Global "c")))) (PrintToChannel (Neg (Var (Global "z"))) "stdOut")))))) undefined undefined undefined)])


exampleMhp2 :: Program Gr
exampleMhp2 = toProgram $ GeneratedProgram
    (Map.fromList [(1,"main"),(3,"thread3")])
    (Map.fromList [("main",Generated (ForC 2 (Seq (CallProcedure "procF") (PrintToChannel (Val 9) "stdOut"))) undefined undefined undefined),("procF",Generated (Seq (SpawnThread 3) (ReadFromChannel (Global "a") "lowIn1")) undefined undefined undefined),("thread3",Generated (Seq (ReadFromChannel (Global "z") "lowIn1") (PrintToChannel (Neg (Var (Global "z"))) "stdOut")) undefined undefined undefined)])


exampleMhp3 :: Program Gr
exampleMhp3 = toProgram $ GeneratedProgram
    (Map.fromList [(1,"main"),(2,"thread2"),(3,"thread3")])
    (Map.fromList [("bar",Generated (Seq (Ass (Global "z") (Val 1)) (CallProcedure "bar")) undefined undefined undefined),
                   ("baz",Generated (Seq (CallProcedure "procH") (CallProcedure "foo")) undefined undefined undefined),
                   ("foo",Generated (Seq (Ass (Global "y") (Val 9)) (Ass (Global "c") (Neg (Var (Global "y"))))) undefined undefined undefined),
                   ("procF",Generated (Seq Skip (CallProcedure "baz")) undefined undefined undefined),
                   ("procH",Generated (Seq (PrintToChannel (Val 9) "stdOut") (Ass (Global "a") (Val 0))) undefined undefined undefined),
                   ("main",Generated (Seq (If CTrue (ForC 1 (Seq (Ass (Global "b") (Val 1)) (ReadFromChannel (Global "z") "stdIn"))) (Seq (SpawnThread 3) (PrintToChannel (Val 9) "stdOut"))) (If CFalse (ForC 1 (Seq (CallProcedure "procF") (Ass (Global "a") (Val 0)))) (If CFalse (CallProcedure "bar") (ReadFromChannel (Global "a") "lowIn1")))) undefined undefined undefined),
                   ("thread2",Generated (Seq (If (Leq (Val 0) (Times (Var (Global "y")) (Var (Global "y")))) (ReadFromChannel (Global "c") "lowIn1") (Ass (Global "b") (Neg (Var (Global "y"))))) (If (Leq (Val 0) (Plus (Var (Global "y")) (Var (Global "y")))) (ReadFromChannel (Global "a") "stdIn") (CallProcedure "bar"))) undefined undefined undefined),
                   ("thread3",Generated (Seq (Seq (Seq (ReadFromChannel (Global "y") "stdIn") (PrintToChannel (Val 1) "stdOut")) (Seq (CallProcedure "bar") (PrintToChannel (Neg (Var (Global "y"))) "stdOut"))) (If (Leq (Val 0) (Times (Var (Global "y")) (Var (Global "y")))) (Seq (Ass (Global "y") (Plus (Var (Global "y")) (Var (Global "y")))) (PrintToChannel (Var (Global "y")) "stdOut")) (Seq (PrintToChannel (Val 0) "stdOut") (SpawnThread 2)))) undefined undefined undefined)])

exampleMhp4 :: Program Gr
exampleMhp4 = toProgram $ GeneratedProgram
    (Map.fromList [(1,"main"),(2,"thread2"),(3,"thread3")])
    (Map.fromList [("main",Generated (Seq (Seq (CallProcedure "procH") (Ass (Global "c") (Val 0))) (Seq (SpawnThread 2) (SpawnThread 3))) undefined undefined undefined),("procH",Generated (PrintToChannel (Val 0) "stdOut") undefined undefined undefined),("thread2",Generated (If (Leq (Val 0) (Var (Global "c"))) (If (Leq (Val 0) (Neg (Var (Global "c")))) (ReadFromChannel (Global "c") "stdIn") (CallProcedure "procH")) (Seq (Ass (Global "b") (Plus (Var (Global "c")) (Var (Global "c")))) (Ass (Global "a") (Plus (Var (Global "b")) (Var (Global "c")))))) undefined undefined undefined),("thread3",Generated (If (Leq (Val 0) (Plus (Var (Global "c")) (Var (Global "c")))) (Ass (Global "a") (Val 0)) (PrintToChannel (Times (Var (Global "c")) (Var (Global "c"))) "stdOut")) undefined undefined undefined)])
...
exampleInteresingAgeSets1 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        ...
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (If (Leq (Val 127) (Plus (Var (Global "e")) (Var (Global "h")))) (If (Leq (Val 127) (Val 136)) (ForV (Global "e") (Seq Skip (AssArr (Array "arrB") (Neg (Var (Global "y"))) (Neg (Var (Global "h")))))) (Seq (Ass (Global "d") (Val 128)) (Ass (Global "b") (Neg (Var (Global "z")))))) (Seq (Seq (AssArr (Array "arrB") (Times (Var (Global "d")) (Var (Global "c"))) (Val 127)) (Ass (Global "d") (Val 126))) (ForV (Global "b") (ForV (Global "h") (AssArr (Array "arrA") (Times (Var (Global "e")) (Var (Global "b"))) (Times (ArrayRead (Array "arrA") (Val 128)) (ArrayRead (Array "arrA") (Neg (Var (Global "y"))))))))))) undefined undefined undefined)])


exampleInteresingAgeSets2 :: Program Gr
exampleInteresingAgeSets2 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (Seq (Seq Skip (AssArr (Array "arrA") (Plus (ArrayRead (Array "arrA") (Plus (ArrayRead (Array "arrC") (Neg (Var (Global "h")))) (ArrayRead (Array "arrC") (Times (ArrayRead (Array "arrB") (Val 126)) (Var (Global "h")))))) (Var (Global "e"))) (Times (ArrayRead (Array "arrA") (Plus (Var (Global "y")) (Var (Global "c")))) (Var (Global "c"))))) (ForC 1 (Ass (Global "b") (Neg (Var (Global "b"))))))) undefined undefined undefined)])


exampleInteresingAgeSets3 :: Program Gr
exampleInteresingAgeSets3 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (Seq (Seq (Seq (AssArr (Array "arrA") (Times (Var (Global "c")) (Var (Global "h"))) (Plus (Var (Global "y")) (Var (Global "y")))) (Ass (Global "c") (Neg (Var (Global "c"))))) (Seq (AssArr (Array "arrA") (Times (Var (Global "y")) (Var (Global "z"))) (Val 128)) Skip)) (Seq (Seq (Ass (Global "z") (Plus (Var (Global "e")) (ArrayRead (Array "arrA") (Neg (Var (Global "h")))))) (Ass (Global "b") (Neg (Var (Global "e"))))) (Seq (AssArr (Array "arrB") (Times (ArrayRead (Array "arrC") (Val 131)) (Var (Global "c"))) (Plus (ArrayRead (Array "arrB") (Plus (ArrayRead (Array "arrA") (Plus (ArrayRead (Array "arrB") (Times (Var (Global "d")) (Var (Global "z")))) (ArrayRead (Array "arrA") (Plus (ArrayRead (Array "arrB") (Plus (Var (Global "z")) (Var (Global "x")))) (Var (Global "z")))))) (Var (Global "h")))) (ArrayRead (Array "arrC") (Val 131)))) (Ass (Global "z") (Neg (ArrayRead (Array "arrB") (Plus (Var (Global "x")) (Var (Global "d")))))))))) undefined undefined undefined)])

exampleInteresingAgeSets4 :: Program Gr
exampleInteresingAgeSets4 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (Seq (Seq (Seq (AssArr (Array "arrC") (Plus (Var (Global "d")) (Var (Global "d"))) (Val 127)) (AssArr (Array "arrB") (Plus (Var (Global "z")) (ArrayRead (Array "arrA") (Times (Var (Global "y")) (Var (Global "x"))))) (Plus (Var (Global "e")) (Var (Global "h"))))) (Seq (AssArr (Array "arrA") (Neg (Var (Global "x"))) (Times (Var (Global "y")) (ArrayRead (Array "arrB") (Neg (Var (Global "z")))))) (AssArr (Array "arrC") (Val 128) (Neg (Var (Global "b")))))) (Seq (Seq (AssArr (Array "arrC") (Times (Var (Global "h")) (ArrayRead (Array "arrB") (Val 127))) (Times (ArrayRead (Array "arrC") (Val 136)) (Var (Global "h")))) (Ass (Global "y") (Neg (Var (Global "b"))))) (ForC 2 (Seq (AssArr (Array "arrC") (Plus (Var (Global "b")) (Var (Global "d"))) (Times (ArrayRead (Array "arrA") (Val 127)) (Var (Global "h")))) (AssArr (Array "arrB") (Val 127) (Val 127))))))) undefined undefined undefined)])

exampleInteresingAgeSets5 :: Program Gr
exampleInteresingAgeSets5 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (Seq (Seq (If (Leq (Val 127) (Times (Var (Global "x")) (Var (Global "h")))) Skip Skip) (Seq Skip (AssArr (Array "arrB") (Times (ArrayRead (Array "arrB") (Val 128)) (Var (Global "b"))) (Val 126)))) (Seq (Seq (Ass (Global "c") (Plus (Var (Global "h")) (ArrayRead (Array "arrB") (Val 131)))) (AssArr (Array "arrC") (Val 127) (Times (Var (Global "b")) (Var (Global "y"))))) (If (Leq (Val 127) (Times (ArrayRead (Array "arrA") (Times (ArrayRead (Array "arrB") (Plus (Var (Global "h")) (Var (Global "e")))) (Var (Global "b")))) (Var (Global "b")))) (Ass (Global "z") (Plus (Var (Global "z")) (Var (Global "x")))) (AssArr (Array "arrC") (Neg (ArrayRead (Array "arrA") (Neg (ArrayRead (Array "arrB") (Times (ArrayRead (Array "arrB") (Val 128)) (Var (Global "x"))))))) (Neg (ArrayRead (Array "arrB") (Plus (Var (Global "x")) (Var (Global "e")))))))))) undefined undefined undefined)])

exampleInteresingAgeSets6 :: Program Gr
exampleInteresingAgeSets6 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
...
exampleInteresingAgeSets10 :: Program Gr
exampleInteresingAgeSets10 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (ForC 2 (ForC 1 (ForC 1 (Seq (Seq (Seq Skip (AssArr (Array "arrC") (Neg (Var (Global "y"))) (Times (Var (Global "y")) (Var (Global "z"))))) (Seq Skip (AssArr (Array "arrB") (Times (Var (Global "z")) (ArrayRead (Array "arrB") (Times (Var (Global "x")) (Var (Global "b"))))) (Val 127)))) (If (Leq (Val 127) (Plus (ArrayRead (Array "arrB") (Times (Var (Global "h")) (ArrayRead (Array "arrB") (Plus (ArrayRead (Array "arrC") (Plus (Var (Global "z")) (ArrayRead (Array "arrA") (Plus (Var (Global "b")) (Var (Global "z")))))) (Var (Global "b")))))) (Var (Global "d")))) (Seq (Ass (Global "e") (Times (ArrayRead (Array "arrB") (Val 127)) (Var (Global "c")))) (AssArr (Array "arrA") (Times (Var (Global "x")) (Var (Global "z"))) (Times (Var (Global "d")) (Var (Global "h"))))) (ForC 2 (ForC 1 (AssArr (Array "arrB") (Plus (ArrayRead (Array "arrA") (Neg (Var (Global "z")))) (Var (Global "e"))) (Neg (ArrayRead (Array "arrC") (Plus (Var (Global "y")) (ArrayRead (Array "arrA") (Plus (ArrayRead (Array "arrA") (Neg (ArrayRead (Array "arrC") (Times (ArrayRead (Array "arrA") (Plus (ArrayRead (Array "arrA") (Neg (Var (Global "y")))) (Var (Global "x")))) (ArrayRead (Array "arrA") (Val 127)))))) (Var (Global "z")))))))))))))))) undefined undefined undefined)])


exampleInteresingAgeSets11 :: Program Gr
exampleInteresingAgeSets11 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (Seq (ForC 1 (ForV (Global "b") (If (Leq (Val 127) (Val 136)) (Seq (Ass (Global "e") (Plus (Var (Global "h")) (Var (Global "z")))) (Ass (Global "e") (Plus (Var (Global "x")) (Var (Global "d"))))) (If (Leq (Val 127) (Times (ArrayRead (Array "arrC") (Neg (ArrayRead (Array "arrB") (Val 131)))) (Var (Global "z")))) (AssArr (Array "arrA") (Val 136) (Neg (ArrayRead (Array "arrA") (Times (ArrayRead (Array "arrC") (Times (Var (Global "y")) (ArrayRead (Array "arrB") (Val 131)))) (ArrayRead (Array "arrC") (Plus (Var (Global "z")) (ArrayRead (Array "arrB") (Neg (ArrayRead (Array "arrC") (Neg (Var (Global "c")))))))))))) (AssArr (Array "arrC") (Neg (ArrayRead (Array "arrA") (Neg (Var (Global "z"))))) (Times (ArrayRead (Array "arrB") (Times (ArrayRead (Array "arrB") (Val 136)) (Var (Global "d")))) (Var (Global "z")))))))) (ForC 2 (If (Leq (Val 127) (Times (ArrayRead (Array "arrA") (Times (ArrayRead (Array "arrC") (Plus (ArrayRead (Array "arrA") (Plus (ArrayRead (Array "arrB") (Plus (ArrayRead (Array "arrA") (Val 131)) (ArrayRead (Array "arrC") (Val 127)))) (Var (Global "z")))) (Var (Global "z")))) (ArrayRead (Array "arrA") (Val 131)))) (Var (Global "h")))) (Seq (AssArr (Array "arrB") (Neg (Var (Global "d"))) (Neg (Var (Global "e")))) (AssArr (Array "arrA") (Times (Var (Global "h")) (Var (Global "x"))) (Neg (Var (Global "h"))))) (Seq (AssArr (Array "arrC") (Neg (Var (Global "z"))) (Times (Var (Global "c")) (Var (Global "d")))) (AssArr (Array "arrB") (Times (Var (Global "b")) (Var (Global "b"))) (Neg (Var (Global "c"))))))))) undefined undefined undefined)])

exampleInteresingAgeSets12 :: Program Gr
exampleInteresingAgeSets12 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (Seq (Seq (Seq (Ass (Global "d") (Times (ArrayRead (Array "arrC") (Val 136)) (ArrayRead (Array "arrB") (Neg (Var (Global "d")))))) Skip) (ForV (Global "x") (Seq (AssArr (Array "arrB") (Plus (ArrayRead (Array "arrB") (Times (ArrayRead (Array "arrC") (Neg (Var (Global "y")))) (Var (Global "y")))) (Var (Global "x"))) (Neg (ArrayRead (Array "arrA") (Plus (ArrayRead (Array "arrC") (Plus (ArrayRead (Array "arrB") (Times (Var (Global "x")) (Var (Global "y")))) (Var (Global "h")))) (ArrayRead (Array "arrC") (Times (ArrayRead (Array "arrB") (Neg (ArrayRead (Array "arrB") (Neg (Var (Global "h")))))) (ArrayRead (Array "arrB") (Times (Var (Global "h")) (ArrayRead (Array "arrC") (Val 126)))))))))) (Ass (Global "e") (Neg (Var (Global "c"))))))) (Seq (Seq (Ass (Global "d") (Val 128)) (Ass (Global "d") (Neg (Var (Global "x"))))) (ForV (Global "z") (Seq (AssArr (Array "arrB") (Plus (ArrayRead (Array "arrC") (Plus (ArrayRead (Array "arrA") (Val 126)) (ArrayRead (Array "arrB") (Val 126)))) (Var (Global "h"))) (Plus (ArrayRead (Array "arrA") (Val 126)) (Var (Global "h")))) (AssArr (Array "arrB") (Val 127) (Plus (Var (Global "x")) (Var (Global "d"))))))))) undefined undefined undefined)])


exampleInteresingAgeSets13 :: Program Gr
exampleInteresingAgeSets13 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
...
exampleInteresingAgeSets16 :: Program Gr
exampleInteresingAgeSets16 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (ForV (Global "x") (ForC 1 (Seq (ForC 2 (ForC 2 (ForC 2 (ForV (Global "c") (ForC 2 (AssArr (Array "arrA") (Val 128) (Plus (Var (Global "z")) (ArrayRead (Array "arrC") (Plus (Var (Global "y")) (Var (Global "z"))))))))))) (Seq (ForC 1 (Seq (Ass (Global "b") (Times (Var (Global "b")) (ArrayRead (Array "arrC") (Val 127)))) Skip)) (ForC 2 (Seq (AssArr (Array "arrA") (Neg (Var (Global "h"))) (Val 128)) (AssArr (Array "arrA") (Val 127) (Val 128))))))))) undefined undefined undefined)])


exampleInteresingAgeSets17 :: Program Gr
exampleInteresingAgeSets17 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (ForC 2 (Seq (If (Leq (Val 127) (Plus (ArrayRead (Array "arrA") (Neg (Var (Global "d")))) (ArrayRead (Array "arrA") (Times (Var (Global "y")) (ArrayRead (Array "arrA") (Times (ArrayRead (Array "arrC") (Neg (Var (Global "y")))) (ArrayRead (Array "arrB") (Neg (Var (Global "e")))))))))) (Seq (Ass (Global "e") (Plus (Var (Global "h")) (Var (Global "e")))) (AssArr (Array "arrC") (Plus (Var (Global "b")) (Var (Global "z"))) (Neg (Var (Global "b"))))) (Seq (AssArr (Array "arrA") (Neg (ArrayRead (Array "arrB") (Val 136))) (Val 128)) (Ass (Global "e") (Val 127)))) (ForV (Global "c") (Seq (ForV (Global "b") (Seq (AssArr (Array "arrC") (Neg (Var (Global "z"))) (Val 131)) (AssArr (Array "arrB") (Val 131) (Plus (Var (Global "c")) (Var (Global "c")))))) (Seq (Ass (Global "x") (Val 131)) (AssArr (Array "arrB") (Times (Var (Global "y")) (Var (Global "e"))) (Val 128)))))))) undefined undefined undefined)])

exampleInteresingAgeSets18 :: Program Gr
exampleInteresingAgeSets18 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (ForC 2 (If (Leq (Val 127) (Times (Var (Global "z")) (ArrayRead (Array "arrB") (Neg (ArrayRead (Array "arrB") (Val 128)))))) (Seq Skip (AssArr (Array "arrB") (Val 126) (Times (Var (Global "c")) (Var (Global "d"))))) (ForC 1 (Ass (Global "d") (Val 131)))))) undefined undefined undefined)])


exampleInteresingAgeSets19 :: Program Gr
exampleInteresingAgeSets19 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (ForC 1 (ForC 1 (ForV (Global "x") (ForC 1 (Seq (ForC 1 (If (Leq (Val 127) (Val 131)) (If (Leq (Val 127) (Plus (Var (Global "y")) (Var (Global "c")))) (Ass (Global "d") (Times (Var (Global "e")) (Var (Global "e")))) (Ass (Global "y") (Neg (ArrayRead (Array "arrB") (Val 131))))) (Seq (AssArr (Array "arrB") (Neg (ArrayRead (Array "arrB") (Times (Var (Global "y")) (Var (Global "d"))))) (Val 128)) (AssArr (Array "arrB") (Val 127) (Val 127))))) (ForV (Global "c") (If (Leq (Val 127) (Neg (ArrayRead (Array "arrB") (Neg (Var (Global "c")))))) (ForC 1 (AssArr (Array "arrB") (Val 131) (Plus (ArrayRead (Array "arrA") (Plus (Var (Global "d")) (ArrayRead (Array "arrB") (Val 127)))) (Var (Global "b"))))) (ForC 2 Skip))))))))) undefined undefined undefined)])

exampleInteresingAgeSets20 :: Program Gr
exampleInteresingAgeSets20 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
...
exampleInteresingAgeSets22 :: Program Gr
exampleInteresingAgeSets22 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (Seq (ForC 1 (If (Leq (Val 127) (Plus (ArrayRead (Array "arrB") (Plus (ArrayRead (Array "arrC") (Plus (Var (Global "x")) (Var (Global "h")))) (Var (Global "h")))) (Var (Global "c")))) (ForV (Global "x") (ForC 1 (AssArr (Array "arrC") (Plus (ArrayRead (Array "arrB") (Plus (Var (Global "x")) (Var (Global "d")))) (ArrayRead (Array "arrB") (Plus (Var (Global "e")) (ArrayRead (Array "arrB") (Val 136))))) (Plus (Var (Global "x")) (Var (Global "h")))))) (If (Leq (Val 127) (Times (ArrayRead (Array "arrA") (Plus (Var (Global "z")) (Var (Global "c")))) (Var (Global "e")))) Skip (Ass (Global "d") (Val 126))))) (Seq (Seq (AssArr (Array "arrC") (Plus (ArrayRead (Array "arrC") (Plus (Var (Global "d")) (Var (Global "y")))) (Var (Global "d"))) (Val 127)) (Ass (Global "e") (Neg (Var (Global "h"))))) (ForC 1 (ForC 2 (AssArr (Array "arrB") (Neg (Var (Global "y"))) (Times (Var (Global "x")) (ArrayRead (Array "arrB") (Times (Var (Global "d")) (Var (Global "b"))))))))))) undefined undefined undefined)])


exampleInteresingAgeSets23 :: Program Gr
exampleInteresingAgeSets23 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (ForV (Global "y") (Seq (If (Leq (Val 127) (Times (ArrayRead (Array "arrC") (Plus (Var (Global "b")) (Var (Global "e")))) (Var (Global "c")))) (Seq (Ass (Global "e") (Neg (Var (Global "x")))) (AssArr (Array "arrC") (Neg (Var (Global "z"))) (Times (Var (Global "e")) (Var (Global "e"))))) (Seq (Ass (Global "e") (Val 128)) (Ass (Global "z") (Plus (Var (Global "b")) (Var (Global "z")))))) (Seq (Seq (AssArr (Array "arrC") (Neg (Var (Global "x"))) (Times (Var (Global "z")) (ArrayRead (Array "arrB") (Plus (Var (Global "b")) (Var (Global "y")))))) (AssArr (Array "arrC") (Times (ArrayRead (Array "arrC") (Plus (Var (Global "y")) (Var (Global "y")))) (ArrayRead (Array "arrB") (Val 128))) (Times (ArrayRead (Array "arrA") (Plus (ArrayRead (Array "arrC") (Neg (ArrayRead (Array "arrA") (Neg (Var (Global "h")))))) (ArrayRead (Array "arrA") (Val 128)))) (Var (Global "z"))))) (If (Leq (Val 127) (Plus (Var (Global "d")) (Var (Global "e")))) (AssArr (Array "arrB") (Plus (Var (Global "h")) (ArrayRead (Array "arrA") (Plus (Var (Global "z")) (ArrayRead (Array "arrA") (Neg (Var (Global "x"))))))) (Val 136)) (AssArr (Array "arrB") (Times (Var (Global "d")) (Var (Global "h"))) (Times (ArrayRead (Array "arrA") (Neg (Var (Global "h")))) (Var (Global "e"))))))))) undefined undefined undefined)])


exampleInteresingAgeSets24 :: Program Gr
exampleInteresingAgeSets24 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (ForC 2 (Seq (If (Leq (Val 127) (Neg (ArrayRead (Array "arrB") (Plus (Var (Global "y")) (Var (Global "x")))))) (ForC 2 (Seq (AssArr (Array "arrB") (Times (ArrayRead (Array "arrB") (Val 128)) (ArrayRead (Array "arrB") (Val 128))) (Neg (ArrayRead (Array "arrC") (Plus (ArrayRead (Array "arrB") (Times (ArrayRead (Array "arrC") (Val 136)) (Var (Global "x")))) (ArrayRead (Array "arrB") (Val 128)))))) (Ass (Global "b") (Neg (Var (Global "z")))))) (If (Leq (Val 127) (Val 136)) (AssArr (Array "arrC") (Neg (Var (Global "d"))) (Plus (ArrayRead (Array "arrB") (Times (Var (Global "h")) (Var (Global "c")))) (ArrayRead (Array "arrA") (Plus (Var (Global "c")) (Var (Global "b")))))) (Ass (Global "d") (Plus (Var (Global "x")) (Var (Global "z")))))) (Seq (If (Leq (Val 127) (Neg (Var (Global "z")))) (Ass (Global "y") (Times (Var (Global "h")) (Var (Global "z")))) (AssArr (Array "arrA") (Val 127) (Times (Var (Global "b")) (Var (Global "c"))))) (ForC 1 (Seq (AssArr (Array "arrC") (Val 128) (Times (ArrayRead (Array "arrC") (Neg (Var (Global "d")))) (ArrayRead (Array "arrC") (Val 127)))) (Ass (Global "c") (Val 126)))))))) undefined undefined undefined)])


exampleInteresingAgeSets25 :: Program Gr
exampleInteresingAgeSets25 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (ForV (Global "h") (ForV (Global "z") (If (Leq (Val 127) (Val 127)) (Seq (ForC 1 (If (Leq (Val 127) (Neg (Var (Global "d")))) Skip (Ass (Global "y") (Neg (Var (Global "d")))))) (ForC 2 (ForV (Global "d") (AssArr (Array "arrC") (Neg (Var (Global "y"))) (Plus (Var (Global "d")) (Var (Global "x"))))))) (Seq (Seq (Ass (Global "b") (Plus (Var (Global "b")) (Var (Global "y")))) (Ass (Global "c") (Times (Var (Global "h")) (Var (Global "z"))))) (ForV (Global "c") (ForV (Global "d") (Ass (Global "e") (Times (Var (Global "x")) (Var (Global "c"))))))))))) undefined undefined undefined)])

exampleInteresingAgeSets26 :: Program Gr
exampleInteresingAgeSets26 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (Seq (Seq (ForV (Global "d") (If (Leq (Val 127) (Plus (Var (Global "z")) (Var (Global "z")))) (Ass (Global "e") (Val 126)) Skip)) (ForC 2 (Seq (AssArr (Array "arrB") (Val 131) (Val 127)) (Ass (Global "e") (Neg (Var (Global "z"))))))) (ForV (Global "x") (Seq (Seq Skip (AssArr (Array "arrC") (Val 128) (Val 127))) (ForV (Global "b") (Seq Skip Skip)))))) undefined undefined undefined)])


exampleInteresingAgeSets27 :: Program Gr
exampleInteresingAgeSets27 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (ForC 2 (If (Leq (Val 127) (Plus (ArrayRead (Array "arrC") (Val 136)) (Var (Global "e")))) (Seq (Seq (Ass (Global "e") (Neg (Var (Global "z")))) (AssArr (Array "arrC") (Val 136) (Times (Var (Global "b")) (Var (Global "c"))))) (ForC 1 (ForC 2 (Ass (Global "z") (Plus (Var (Global "z")) (Var (Global "z"))))))) (If (Leq (Val 127) (Neg (Var (Global "d")))) (If (Leq (Val 127) (Val 127)) (Ass (Global "b") (Val 136)) Skip) (ForC 1 (Seq (Ass (Global "z") (Times (Var (Global "h")) (ArrayRead (Array "arrC") (Times (ArrayRead (Array "arrC") (Plus (Var (Global "c")) (Var (Global "b")))) (Var (Global "e")))))) (Ass (Global "y") (Neg (Var (Global "z")))))))))) undefined undefined undefined)])


exampleInteresingAgeSets28 :: Program Gr
exampleInteresingAgeSets28 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (ForV (Global "y") (Seq (ForC 2 (If (Leq (Val 127) (Val 131)) (Seq (AssArr (Array "arrB") (Val 126) (Val 127)) (AssArr (Array "arrA") (Times (ArrayRead (Array "arrA") (Plus (Var (Global "b")) (Var (Global "x")))) (Var (Global "x"))) (Plus (Var (Global "e")) (Var (Global "b"))))) (ForC 1 (Seq Skip (Ass (Global "z") (Plus (Var (Global "d")) (Var (Global "e")))))))) (If (Leq (Val 127) (Neg (ArrayRead (Array "arrB") (Val 127)))) (ForC 2 (Seq (Ass (Global "c") (Val 128)) (Ass (Global "c") (Times (Var (Global "e")) (ArrayRead (Array "arrB") (Neg (Var (Global "y")))))))) (Seq (AssArr (Array "arrB") (Times (ArrayRead (Array "arrC") (Plus (Var (Global "e")) (ArrayRead (Array "arrB") (Times (ArrayRead (Array "arrB") (Neg (ArrayRead (Array "arrC") (Times (Var (Global "h")) (Var (Global "h")))))) (ArrayRead (Array "arrA") (Times (ArrayRead (Array "arrA") (Neg (Var (Global "z")))) (Var (Global "c")))))))) (Var (Global "e"))) (Neg (ArrayRead (Array "arrA") (Neg (Var (Global "h")))))) (Ass (Global "x") (Neg (Var (Global "h"))))))))) undefined undefined undefined)])


exampleInteresingAgeSets29 :: Program Gr
exampleInteresingAgeSets29 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (Seq (ForC 2 (Seq (ForC 2 (If (Leq (Val 127) (Neg (Var (Global "x")))) (AssArr (Array "arrC") (Plus (Var (Global "b")) (ArrayRead (Array "arrA") (Times (Var (Global "b")) (Var (Global "x"))))) (Neg (ArrayRead (Array "arrB") (Plus (ArrayRead (Array "arrA") (Val 128)) (Var (Global "c")))))) (AssArr (Array "arrA") (Neg (Var (Global "h"))) (Plus (ArrayRead (Array "arrB") (Neg (Var (Global "b")))) (Var (Global "d")))))) (If (Leq (Val 127) (Times (Var (Global "x")) (ArrayRead (Array "arrC") (Neg (ArrayRead (Array "arrA") (Plus (ArrayRead (Array "arrC") (Val 128)) (Var (Global "c")))))))) (AssArr (Array "arrC") (Plus (Var (Global "b")) (Var (Global "z"))) (Val 127)) (Ass (Global "e") (Plus (ArrayRead (Array "arrA") (Times (Var (Global "x")) (Var (Global "z")))) (Var (Global "x"))))))) (Seq (Seq (Ass (Global "z") (Times (Var (Global "c")) (Var (Global "b")))) (Ass (Global "x") (Val 136))) (ForV (Global "c") (Seq Skip (Ass (Global "z") (Neg (Var (Global "c"))))))))) undefined undefined undefined)])


exampleInteresingAgeSets30 :: Program Gr
exampleInteresingAgeSets30 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
        generated = SimpleWithArraysProgram (Map.fromList [(1,"main")]) (Map.fromList [("main",Generated (Seq Skip (Seq (If (Leq (Val 127) (Times (ArrayRead (Array "arrB") (Neg (ArrayRead (Array "arrB") (Times (Var (Global "d")) (Var (Global "e")))))) (Var (Global "c")))) (If (Leq (Val 127) (Plus (ArrayRead (Array "arrC") (Val 128)) (ArrayRead (Array "arrC") (Neg (ArrayRead (Array "arrC") (Plus (ArrayRead (Array "arrB") (Times (Var (Global "x")) (ArrayRead (Array "arrA") (Times (Var (Global "x")) (Var (Global "h")))))) (ArrayRead (Array "arrB") (Plus (Var (Global "b")) (Var (Global "y")))))))))) (Ass (Global "y") (Times (Var (Global "y")) (Var (Global "e")))) (AssArr (Array "arrA") (Neg (Var (Global "d"))) (Plus (Var (Global "z")) (Var (Global "d"))))) (If (Leq (Val 127) (Times (Var (Global "e")) (Var (Global "y")))) (AssArr (Array "arrB") (Times (ArrayRead (Array "arrC") (Times (ArrayRead (Array "arrB") (Plus (Var (Global "b")) (Var (Global "y")))) (Var (Global "e")))) (Var (Global "h"))) (Neg (Var (Global "c")))) (Ass (Global "y") (Times (Var (Global "d")) (Var (Global "c")))))) (Seq (ForV (Global "e") (ForV (Global "z") (Ass (Global "x") (Plus (Var (Global "h")) (Var (Global "c")))))) (Seq (AssArr (Array "arrB") (Val 126) (Plus (ArrayRead (Array "arrB") (Neg (Var (Global "e")))) (ArrayRead (Array "arrA") (Times (ArrayRead (Array "arrC") (Times (ArrayRead (Array "arrC") (Neg (Var (Global "y")))) (Var (Global "b")))) (Var (Global "c")))))) (AssArr (Array "arrA") (Times (Var (Global "z")) (ArrayRead (Array "arrB") (Plus (ArrayRead (Array "arrB") (Plus (Var (Global "h")) (Var (Global "b")))) (Var (Global "d"))))) (Plus (Var (Global "e")) (Var (Global "x")))))))) undefined undefined undefined)])

-- cacheSize 6
exampleInteresingAgeSets31 :: Program Gr
exampleInteresingAgeSets31 = compileAllToProgram a b'
  where (a,b) = toCodeSimpleWithArrays generated
        b' = fmap twoAddressCode b
...
interestingAgeSets :: [(String, Program Gr)]
interestingAgeSets = [
              $(withName 'exampleInteresingAgeSets1 ),
              $(withName 'exampleInteresingAgeSets2 ),
              $(withName 'exampleInteresingAgeSets3 ),
              $(withName 'exampleInteresingAgeSets4 ),
              $(withName 'exampleInteresingAgeSets5 ),
              $(withName 'exampleInteresingAgeSets6 ),
              $(withName 'exampleInteresingAgeSets7 ),
              $(withName 'exampleInteresingAgeSets8 ),
              $(withName 'exampleInteresingAgeSets9 ),
              ...
              $(withName 'exampleInteresingAgeSets16),
              ...
              $(withName 'exampleInteresingAgeSets22),
              $(withName 'exampleInteresingAgeSets23),
              $(withName 'exampleInteresingAgeSets24),
              $(withName 'exampleInteresingAgeSets25),
              $(withName 'exampleInteresingAgeSets26),
              $(withName 'exampleInteresingAgeSets27),
